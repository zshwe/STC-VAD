...
def train(model, train_loader, test_loader, args, label_map: dict, device):
    ...
    scheduler = MultiStepLR(optimizer, args.scheduler_milestones, args.scheduler_rate) #使用scheduler_milestones
...
if __name__ == '__main__':
    ...
    model = STCVAD(args.classes_num, args.embed_dim, args.visual_length, args.visual_width, args.visual_head, args.visual_layers, args.attn_window, args.prompt_prefix, args.prompt_postfix, device)
