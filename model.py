...
class ResidualAttentionBlock(nn.Module):
    def __init__(self, d_model: int, n_head: int, attn_mask: torch.Tensor = None):
        ...
        self.attn = nn.MultiheadAttention(d_model, n_head) #原来的
...
class STCVAD(nn.Module):
    def __init__(self,
        ...
        self.afa = AFA(512)
        self.mtm = MTM(dim=512)
        self.sca = SCA(dim1=visual_width)
